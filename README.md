...
[Geological Landforms](https://github.com/m00nl1ght-dev/GeologicalLandforms) appeared compatible during testing. Its cave landforms are generated by Geological Landforms rather than by the vanilla cave pass this mod disables. Surface Caves and Directional Caves both still generate; this mod only blocks vanilla cave generation.

Other map-generation mods should be fine unless it relies directly on RimWorld's vanilla cave generator. If another mod creates caves through its own generation system, those caves will likely still appear.
