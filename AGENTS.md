...
Do not describe or implement this as a universal blocker for every modded cave system. The maintained behavior is narrower: patch vanilla cave generation and leave independent mod generators alone unless the user explicitly asks for broader behavior.
